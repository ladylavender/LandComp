...
test_that(desc = "strange or extreme x",
          code = {
            ...
            column1 = LandComp(x = square_data[,1], aggregation_steps = 0:1)
            ...
            column000 <- LandComp(x = other_extreme_data[,"VT000"], aggregation_steps = 0)
            ...
            column111 <- LandComp(x = other_extreme_data[,"VT000"], aggregation_steps = 1)
...
test_that(desc = "inappropriate parallelrun",
          code = {
            ...
            expect_warning(object = LandComp(x = square_data, aggregation_step = 3, parallelrun = c(TRUE, FALSE)))
          }
)
...
test_that(desc = "inappropriate savememory",
          code = {
            ...
            expect_warning(object = LandComp(x = square_data, aggregation_step = 3, savememory = c(TRUE, FALSE)))
          }
)
...
test_that(desc = "inappropriate precision",
          code = {
            ...
            expect_warning(object = LandComp(x = square_data, aggregation_step = 3,precision = c(4, 5)))
          }
)
