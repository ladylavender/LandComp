...
**Fig. 2.** Main properties of the spatial units used for the calculation of Juhász-Nagy's functions. In the integer aggregation steps, radially enlarged spatial units consisting of 9, 25, 49 etc. squares are yielded. Spatial units of fraction aggregation steps are created by removing the vertices of the spatial unit of the next aggregation step. A~s~ is the area of the square grid cell of the input data. 
...
**Fig. 4.** Main properties of the spatial units used for the calculation of Juhász-Nagy's functions. In the integer aggregation steps, radially enlarged spatial units consisting of 7, 19, 37 etc. hexagons are yielded. Spatial units of fraction aggregation steps are created by removing the vertices of the spatial unit of the next aggregation step. A~h~ is the area of the hexagonal grid cell of the input data. 
